...
const getSections = async (ID) => {
  ...
  const sections3 = `3.1. Общая стоимость настоящего Договора составляет ${numberToWordsRU(
    totalAmount
  )} тенге, сумма договора включает в себя стоимость материалов и работ, сборка в ЦЕХу. 3.2. Заказчик в момент подписания Договора вносит 70% предоплату от обшей суммы Договора, что составляет ${numberToWordsRU(
    seventyPercent
  )}  тенге, 30% в размере ${numberToWordsRU(
    thirtyPercent
